  ...
  <div class="auth">
    ...
    <aside class="auth-brand">
      ...
      <div class="auth-brand__inner">
        ...
        <p class="auth-sub">
          Acesse o acervo, faça empréstimos, acompanhe devoluções e gerencie seu
          histórico de leituras com facilidade.
        </p>
    ...
    <div class="auth-form">
      <div class="auth-form__inner">
        ...
        <div class="auth-form__head">
          ...
          <p>
            Não tem conta?
            <RouterLink to="/signup">Cadastre-se grátis</RouterLink>
          </p>
        </div>
        ...
        <form @submit.prevent="handleSubmit">
          ...
          <button
            type="submit"
            class="btn btn-primary btn-pill btn-lg btn-block"

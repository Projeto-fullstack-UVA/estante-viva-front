...
const handleEditEvent = async () => {
  if (!editingEvent.value || editForm.value.institution_id === "") return;
  try {
    await eventService.updateEvent(editingEvent.value.id, {
      name: editForm.value.name,
      description: editForm.value.description,
      location: editForm.value.location,
      date: editForm.value.date,
      institution_id: editForm.value.institution_id,
    });
...
const handleDeleteEvent = async (event: Event) => {
  if (
    !confirm(
      `Remover o evento "${event.name}"? Esta ação não pode ser desfeita.`,
    )
  ) {
    return;
  }
  ...
  <TeacherLayout>
    ...
    <Teleport to="body">
      <div
        ...
        @click.self="isAddingEvent = false"
      >
          ...
          <form @submit.prevent="handleAddEvent">
            ...
            <div class="modal-body">
              ...
              <div class="field">
                ...
                <select
                  id="ev-institution"
                  v-model="newEvent.institution_id"
                  required
                >
      ...
      >
        <div class="modal" role="dialog" aria-modal="true">
          <form @submit.prevent="handleEditEvent">
            <div class="modal-head">
              <span class="modal-title">Editar evento</span>
              <button
                type="button"
                class="modal-close"
                aria-label="Fechar"
            ...
            <div class="modal-body">
              <div class="field">
                <label for="ev-edit-name">Nome</label>
                <input
                  id="ev-edit-name"
              ...
              <div class="field">
                <label for="ev-edit-description">Descrição</label>
                <textarea
              ...
              <div class="field">
                <label for="ev-edit-location">Local</label>
                <input
                  id="ev-edit-location"
              ...
              <div class="field">
                <label for="ev-edit-date">Data</label>
                <input
                  id="ev-edit-date"
              ...
              <div class="field">
                <label for="ev-edit-institution">Instituição</label>
                <select
                  id="ev-edit-institution"

...
const handleDeleteBook = async (book: Book) => {
  if (
    !confirm(
      `Remover o livro "${book.title}"? Esta ação também remove seus empréstimos e não pode ser desfeita.`,
    )
  ) {
    return;
  }
